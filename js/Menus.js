 ...
 * Sets the default font size.
 */
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'help', 'settings']; //operation

Menus.prototype.agnityMenuItems = ['file', 'edit', 'view', 'arrange', 'settings']; //operation
/**
...
Menus.prototype.init = function()
{
	...
	this.put('arrange', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		if(Agnity.hasUrlDebugParam())
		{
			...
			this.addMenuItems(menu, ['-', 'group', 'ungroup', 'removeFromGroup', '-', 'clearWaypoints', 'autosize'], parent); // group
		}
		else
		{
			this.addMenuItems(menu, ['clearWaypoints', 'autosize'], parent); // group
		}
	...
	this.put('view', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		if(Agnity.hasUrlDebugParam())
		{
			this.addMenuItems(menu, ['outline', 'layers', 'formatPanel', '-', 'pageView', 'pageScale', '-', 'scrollbars', 'tooltips', '-',
			      			        'grid', 'guides', '-', 'connectionArrows', 'connectionPoints', '-',
			      			        'resetView', 'zoomIn', 'zoomOut'], parent);
		}
		else
		{
			this.addMenuItems(menu, ['pageView', 'pageScale', '-', 'scrollbars', 'tooltips', '-',
				      			        'grid', 'guides', '-', 'connectionArrows', 'connectionPoints', '-',
				      			        'resetView', 'zoomIn', 'zoomOut'], parent); // outline
		}
	})));
	...
	if(Agnity.isComponentDiagram())
	{
		this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
		                                       {
			this.addMenuItems(menu, ['newComponent', 'openComponent', 'downloadComponent', '-', 'newTree', 'loadTreeDialog', '-', 'newProcess', 'loadProcess_dlg', '-', 'saveComponent_int', 'loadComponent_dlg', 'deleteDialog', '-', 'deleteFunctionTemplateDialog', 'saveAsProcess', 'saveTemplateDialog', 'loadTemplateDialog', '-', 'pageSetup', 'print'], parent);
		                                       })));
	}
	else if(Agnity.isProcessDiagram())
	{
		this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
		                                       {
			this.addMenuItems(menu, ['newProcess', 'openProcess', 'downloadServiceXml_int', '-', 'newTree', 'loadTreeDialog', '-', 'saveProcess_int', 'loadProcess_dlg', 'deleteDialog', '-', 'importProcess', 'exportProcess', '-', 'deleteProcessDialog', '-', 'pageSetup', 'print']);
		                                       })));
	}
	else if(Agnity.isDBSchemaDiagram())
	{
		this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
               	{
               		this.addMenuItems(menu, ['newTree', 'newProcess', 'newComponent', '-', 'saveDBSchema_int', 'downloadDBSchema_int', '-', 'pageSetup', 'print'], parent); // 'saveAsProcess', 'saveTemplateDialog', 'downloadServiceXml_int', 'openTree', 'loadProcess_dlg', 'saveAsProcess', 'loadComponent_dlg', 'loadTreeDialog', 'deleteDialog', '-', 'importTree', 'exportTree', '-', 'deleteTreeTemplateDialog', 'loadTemplateDialog', '-', 'openServiceXmlDialog',
               	})));
	}
	else
	{
		this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
		                                   	{
		                                   		this.addMenuItems(menu, ['newTree', 'openTree', '-', 'newProcess', 'loadProcess_dlg', 'saveAsProcess', '-', 'newComponent', 'loadComponent_dlg', '-', 'saveUiXml_int', 'loadTreeDialog', 'deleteDialog', '-', 'importTree', 'exportTree', '-', 'deleteTreeTemplateDialog', 'saveAsProcess', 'saveTemplateDialog', 'loadTemplateDialog', '-', 'downloadServiceXml_int', 'openServiceXmlDialog', '-', 'pageSetup', 'print'], parent);
		                                   	})));
	}
	
	this.put('operation', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['develop_int', 'test_int', 'deploy_int', 'activate_int'], parent);
	})));
	this.put('edit', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		{
			this.addMenuItems(menu, ['undo', 'redo', '-', 'cut', 'copy', 'paste', 'delete', 'duplicate', '-',
               'edit', '-', 'selectVertices', 'selectEdges', 'selectAll', 'selectNone']); //editStyle, lockUnlock
		}
	})));
	...
	this.put('settings', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['casConfigureDialog', 'manageCASDialog', 'manageCASGroupDialog', 'packageApplicationDialog', 'appRouterDialog', '-', 'dbDetailDialog', 'schemaBuilderDiagram', 'userDefinedDBSchema']);
	})));
};
...
Menus.prototype.createMenubar = function(container)
{
	...
	{
		var menus = this.agnityMenuItems;
	}
